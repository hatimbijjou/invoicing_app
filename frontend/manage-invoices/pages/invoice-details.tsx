...
type FormInvoiceDetailsProps = {

}

export const FormInvoiceDetails: React.FC<FormInvoiceDetailsProps> = () => {
    const {id} = useParams()
    ...
    const fetchInvoice = () => {
        axios.get(`http://localhost:3000/api/v1/invoices/${id}`)
            .then((res) => {
                setInvoice(res.data)
    ...
    return (
        <div className="w-full p-4">
            ...
            <div className="w-1/3 h-full shadow-md rounded p-4">
